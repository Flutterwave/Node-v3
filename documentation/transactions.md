...
This section describes how to fetch all transactions on your account.
...
This section describes how to get transaction fees.
...
This section describes how to resend failed transaction webhooks.
...
This section describes how to initiate a transaction refund.
...
const refund = async () => {
    ...
    try {
        ...
        const payload = {
            "id": "5708", //This is the unique transaction identifier. It is returned in the initiate transaction call as 'data.id'.
            "amount":"10"
        }
...
This section describes how to verify transaction status using the transaction id.
...
const verify = async () => {
    ...
    try {
        const payload = {"id": "288200108" //This is the unique transaction identifier. It is returned in the initiate transaction call as 'data.id'.
        }
...
const verify_by_tx = async () => {
    ...
    try {
        const payload = {"tx_ref": "txref-DI0NzMx13" //This is the unique transaction reference generated by you. It is returned in the initiate transaction call as 'data.tx_ref'.
        }
...
const View_Transaction_Timeline = async () => {
    ...
    try {
        const payload = {
            "id": "1296063" //This is the unique transaction indentifier. It is returned in the verify transaction call as 'data.id'.
        }
